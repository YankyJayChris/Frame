...
exports.registerIconPicker = registerIconPicker;
...
function registerIconPicker(context) {
    const disposables = [];
    disposables.push(vscode.commands.registerCommand('frame.showIcons', async () => {
